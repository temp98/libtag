...
{
    m_contents = Nametag::C_name | Nametag::C_speech;
    m_chat_wordwrap = 7.5;
...
void Nametag2d::show_name()
{
    ...
    m_arrow = &NametagGlobals::arrow_model.copy_to(m_inner_np);
...
void Nametag2d::tick()
{
    ...
    NodePath camera = NametagGlobals::camera;
    NodePath toon = NametagGlobals::toon.is_empty() ? camera : NametagGlobals::toon;
...
bool Nametag2d::is_displayed()
{
    ...
    return m_chat_flags & NametagConstants::CF_speech;
}
